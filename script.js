...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "systems.law.f1": "AI consultation intake",
      "systems.law.f2": "Case type routing",
      "systems.law.f3": "Appointment booking",
      "systems.law.f4": "Bilingual FAQ",
      "systems.law.f5": "Lead summary email",
      "systems.law.status": "Demo coming soon",
    ...
    zh: {
      ...
      "systems.law.f1": "AI 咨询收集",
      "systems.law.f2": "案件类型分类",
      "systems.law.f3": "预约咨询",
      "systems.law.f4": "中英双语 FAQ",
      "systems.law.f5": "自动生成客户摘要",
      "systems.law.status": "Demo 即将上线",
